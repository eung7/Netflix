...
class ServiceAPI {
    ...
    static func fetchMovies(from term: String, completion: @escaping ([Item]) -> Void) {
        ...
        URLSession.shared.dataTask(with: request) { data, response, error in
            ...
            DispatchQueue.main.async {
                do {
                    ...
                    let object = try JSONDecoder().decode(Result.self, from: data!).results
    ...
    static func fetchMoviesWithAF(from term: String, completion: @escaping ([Item]) -> Void) {
